...
export default function DetectPage() {
    ...
    const getStatusColor = (estado: string) => {
        switch (estado) {
            ...
            case 'moderado': return 'text-[#e85706] bg-orange-50';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
            {/* Cabecera: permanece visible al hacer scroll (igual que la home) */}
            ...
            <main className="container mx-auto overflow-x-clip px-4 py-8 md:py-12">
                <div className="mx-auto max-w-4xl">
                    ...
                    <div className="rounded-xl bg-white p-5 shadow-lg md:p-8">
                        ...
                        {/* Action Buttons */}
                        <div className="mb-8 flex flex-row gap-3 md:gap-4">
                            <button
                                type="button"
